...
public class ArtistaController {
	...
	public ResponseEntity<Artista> crearArtista(@RequestBody Artista nuevo) {
		return new ResponseEntity<Artista>(artistaDataManager.save(nuevo), HttpStatus.CREATED);
	}
